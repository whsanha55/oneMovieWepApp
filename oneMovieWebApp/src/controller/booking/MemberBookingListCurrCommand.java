...
//			String memberNo = "17121500004";
			...
			int totalPost = bookingService.retrieveCountBookingList("memberNo", memberNo, 2);
			...
			List<BookingVO> bookingList = bookingService.retrieveBookingList("memberNo",memberNo,2,startRow,endRow);
			req.setAttribute("bookingList", bookingList);
			forward.setPath("/layoutUser.jsp?article=/user/booking/auth/memberBookingListCurr.jsp");
