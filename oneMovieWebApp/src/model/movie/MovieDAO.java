...
>>>>>>> refs/remotes/origin/master
	...
	public DetailMovieVO selectMovie(int movieNo) throws Exception {
		...
		try {
			...
			StringBuffer sql = new StringBuffer();
			sql.append(
					"select m1.movie_no,m1.movie_title, m1.director, m1.running_time, g.grade_age,n.nation_name,m1.story, r.role_name, m2.actor_name, m2.character_name 	 							 ");
			sql.append(
					"from movie m1, actor m2 , role r, grade g, nation n	 	     										");
			sql.append(
					"where m1.movie_no = m2.movie_no(+) and m2.role_no = r.role_no	and g.grade_no = m1.grade_no and n.nation_no = m1.nation_no						 										");
