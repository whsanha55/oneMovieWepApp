				...
				$.ajax({
					...
					success: function(data) {
						...
						for(var i=0; i<data.length; i++) {
							...
							htmlStr += "<td><a href='${pageContext.request.contextPath}/admin/movie/detailMovie.do?movieNo=" +data[i].movieNo +" '>상세정보보기</a></td>";
							htmlStr += "</tr>";
 ...
 <body>
  ...
  <form id="form">
   ...
   <form id="form1">
   	 ...
   	 <form id="form3" action="${pageContext.request.contextPath}/user/movie/writeMovieForm.jsp" method="post">
   			<button id="writeMovieBtn" type="submit">영화추가하기</button>
    </form>
