...
<html>
 ...
 <body>
    ...
    enctype="multipart/form-data" method="post">
       <input type="hidden" name="movieNo" value="${requestScope.movie.movieNo }"> <br>
       영화 기본 정보<br>
       <table border=1>
       	<tr>
       		<th>제    목</th>
       		<td><input type="text" name="movieTitle" size="20" value="${requestScope.movie.movieTitle }"></td>
       	</tr>
       	       	<tr>
       		<th>상영시간</th>
       		<td><input type="number" name="runningTime" size="20" value="${requestScope.movie.runningTime }"></td>
       	</tr>
       	       	<tr>
       		<th>감    독</th>
       		<td><input type="text" name="director" size="20" value="${requestScope.movie.director }"></td>
       	</tr>
       	       	<tr>
       		<th>등    급</th>
       ...
       <%--  업로드된 파일 목록 조회    --%>
        ...
        <c:forEach var="actor" items="${requestScope.movie.actors }" varStatus="loop">
                        ...
                        캐릭터이름 : <input type="text" name="characterName" size="20" value="${pageScope.actor.characterName }"> </p>
      </c:forEach>
